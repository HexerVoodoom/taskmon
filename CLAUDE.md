...
| 🎀 Presentes | Na 4ª casinha: transfere 1 comida do inventário do perfil ATIVO pro inventário de outro perfil (`handleGiftFood` no App decrementa o ativo via setGameState e escreve o alvo direto no localStorage — alvo é sempre inativo). 💗/🌀 não são presenteáveis. |
