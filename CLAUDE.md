...
| 🧺 Piquenique | Meta COOPERATIVA semanal na 4ª casinha (`TogetherHome`): soma das tarefas reais dos 3 perfis na semana (leitura pura de `completedTasks`, `FAMILY_WEEK_GOAL=15`); bater a meta renderiza o piquenique dos 3 pets. NUNCA ranking entre perfis. |
