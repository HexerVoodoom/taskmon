    ...
    items: [
      {
        ...
        labelEn: 'HP (Hearts)',
        labelPt: 'HP (Corações)',
        descEn: 'Your pet\'s health. At day\'s end you lose hearts for what you left undone vs. the phase requirement; uncleaned poop drains 1 heart every 6h. Healed by rubbing (max 1 heart/day) or by using a Little Heart item (shop / dungeon drop). Reaches 0 → back one phase (you keep a head start of half the perfect days to climb back; doesn\'t stack).',
        descPt: 'A saúde do seu pet. Na virada do dia você perde corações pelo que faltou em relação ao requisito da fase; cocô não limpo tira 1 coração a cada 6h. Recupera esfregando (máx. 1 coração/dia) ou usando um Coraçãozinho (loja / drop da masmorra). Chega a 0 → volta uma fase (você mantém metade dos dias perfeitos de vantagem para voltar; não acumula).',
      },
      {
        icon: '⚡',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        descEn: 'The Shop has tabs, and some items show darkened with a 🔒: tap one to see how to unlock its purchase. Missions (reach a phase, defeat dungeon enemies, high scores…) unlock exclusive backdrops.',
        descPt: 'A Loja tem abas, e alguns itens aparecem escurecidos com 🔒: toque para ver como liberar a compra. Missões (chegar a uma fase, derrotar inimigos na masmorra, recordes…) liberam cenários exclusivos.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        labelEn: 'Items',
        labelPt: 'Itens',
        descEn: 'Your inventory. Food refills energy (up to 5 feedings/hour). Shop items also live here: Little Hearts heal 1 HP and the Glitchtama grants a perfect day — neither counts against the food limit.',
        descPt: 'Seu inventário. Comida enche energia (até 5 refeições/hora). Itens da loja também ficam aqui: Coraçõezinhos curam 1 HP e o Glitchtama dá um dia perfeito — nenhum conta no limite de comida.',
      },
      {
        icon: '🚿',
        labelEn: 'Bath',
