  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        descEn: 'Every real task any of you finishes drops a COPY of the treat into the shared basket (you keep yours!). Fill it with 15 treats and the picnic happens — then each pet picks up a 💗 there, once a week. Teamwork, never a ranking!',
        descPt: 'Cada tarefa real que qualquer uma faz joga uma CÓPIA da comidinha na cesta comum (a sua você guarda!). Junte 15 e o piquenique acontece — aí cada pet pega um 💗 lá, uma vez por semana. Trabalho em equipe, nunca ranking!',
      },
      {
        icon: '🎀',
        labelEn: 'Donate an item',
        labelPt: 'Doar um item',
        descEn: 'In your backpack, tap any item and choose Use or Gift — gifting sends it to another pet\'s inventory as a surprise. Kindness counts!',
        descPt: 'Na sua mochila, toque num item e escolha Usar ou Doar — doar manda ele pro inventário do pet de outra casinha, de surpresa. Gentileza conta!',
      },
      {
        icon: '🎓',
